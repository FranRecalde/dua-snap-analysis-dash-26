...
async function triggerPptxExport() {
  ...
  try {
    ...
    const fileName = await exportPowerPointPresentation({
      ...
      classListsData,
      qlaPapers: currentQlaData?.papers || null,
      qlaAssessmentTitle: currentQlaData?.assessmentTitle || '',
      qlaFilters: qlaTabFilters,
      qlaQuestionFilters: qlaQuestionsState.filters,
      qlaActionThresholds: qlaActionsState.thresholds,
